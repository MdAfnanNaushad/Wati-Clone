 ...
 * Pure Vanilla JS  |  No frameworks  |  BEM selectors
 */
...
(function () {
  ...
  /* =====================================================
     1. STICKY HEADER — adds .header--scrolled on scroll
     ===================================================== */
  ...
  onScroll(); // run on load to set correct initial state
  ...
  /* =====================================================
     3. MOBILE DROPDOWN TOGGLES
        On mobile, clicking a nav link toggles its dropdown
     ===================================================== */
  var dropdownItems = navMenu.querySelectorAll('.nav__item--dropdown');
  ...
  /* =====================================================
     8. HERO HIGHLIGHT BOX — typed text cycle effect
        The green highlight words rotate every few seconds
        to give the "animation" feel similar to WATI site
     ===================================================== */
  var highlightWords = [
